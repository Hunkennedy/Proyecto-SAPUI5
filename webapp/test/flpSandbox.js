		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestion de usuarios en servidores",
									"targetURL": "#academia2022zluuc3games-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"academia2022zluuc3games-display": {
								"semanticObject": "academia2022zluuc3games",
								"action": "display",
								"description": "Visualizacion y gestion de usuarios",
								"title": "Gestion de usuarios en servidores",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=academia2022.zluuc3games",
									"url": sap.ui.require.toUrl("academia2022/zluuc3games")
								}
							}
						}
					}
